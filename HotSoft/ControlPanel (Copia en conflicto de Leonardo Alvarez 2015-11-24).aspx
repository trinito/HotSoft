    ...
    <form id="form1" runat="server">
                        ...
                        <tr>
                            <td>
                                <div class="ContSlider">
                                     ...
                                     <input id="RangeProgCriterio" value="0" type="range" runat="server" min="0" max="100" oninput="document.getElementById('lblRangeCriterio').textContent = this.value;"  />
                                     <asp:Label ID="lblRangeCriterio" runat="server" Text="0" ForeColor="#329040"></asp:Label>
                                </div>
                            </td>
                          </tr>
                          <tr>
                            <td><%--<asp:RadioButton ID="RbJr" runat="server" Text="Junior" CssClass="Rbtn" GroupName="A" />--%>
                                 <div class="ContSlider">
                                     ...
                                     <input id="RangeJunior" value="0" type="range" runat="server" min="0" max="100" oninput="document.getElementById('lblJunior').textContent = this.value;"  />
                                     <asp:Label ID="lblJunior" runat="server" Text="0" ForeColor="#329040"></asp:Label>
                               </div>
                             </td>
                        </tr>
                        <tr>
                            <td>  <%--<asp:RadioButton ID="RbMdd" runat="server" Text="Middle" CssClass="Rbtn" GroupName="A" />--%>
                                <div class="ContSlider">
                                     ...
                                     <input id="RangeMiddle" value="0" type="range" runat="server" min="0" max="100" oninput="document.getElementById('lblMiddle').textContent = this.value;"  />
                                    <asp:Label ID="lblMiddle" runat="server" Text="0" ForeColor="#329040"></asp:Label>
                               </div>
                            </td> 
                        </tr>
                        <tr>
                              <td> <%--<asp:RadioButton ID="RbSr" runat="server" Text="Senior" CssClass="Rbtn" GroupName="A" />--%>
                                   <div class="ContSlider">
                                         ...
                                         <input id="RangeSenior" value="0" type="range" runat="server" min="0" max="100" oninput="document.getElementById('lblSenior').textContent = this.value;"  />
                                        <asp:Label ID="lblSenior" runat="server" Text="0" ForeColor="#329040"></asp:Label>
                                   </div>
                              </td>
                        </tr>
                    </table>
            ...
            <div class="FormEstudios">
                <div class="FormGroup">
                    ...
                    <br />
                      <div class="ContSlider">
                            <h3>Asigne un valor para este criterio</h3>
                            <input id="Range2" value="0" type="range" runat="server" min="0" max="100" oninput="document.getElementById('Label2').textContent = this.value;"  />
                             <asp:Label ID="Label2" runat="server" Text="0" ForeColor="#329040"></asp:Label>
                      </div>
             ...
             <div class="FormCert">
                 <div class="FormGroup">
                      ...
                      <div class="ContSlider">
                          <h3>Asigne un valor para este criterio</h3>
                          <input id="Range3" type="range" runat="server" value="0" min="0" max="100" oninput="document.getElementById('Label3').textContent = this.value;"  />
            ...
            <div class="FormAptitud">
                <div class="FormGroup">
                      ...
                      <div class="ContSlider">
                          <h3>Asigne un valor para este criterio</h3>
                          <input id="Range4" type="range" runat="server" value="0" min="1" max="100" oninput="document.getElementById('Label4').textContent = this.value;"  />
                           <asp:Label ID="Label4" runat="server" Text="0" ForeColor="#329040"></asp:Label>
                      </div>
                      <div class="checkbox">
                              <table style="width: 93%;">
                                <tr>
             ...
             <div class="FormCursos">
                 <div class="FormGroup">
                       ...
                       <div class="ContSlider">
                            <h3>Asigne un valor para este criterio</h3>
                            <input id="Range5" type="range" runat="server" value="0" min="1" max="100" oninput="document.getElementById('Label5').textContent = this.value;"  />
                            <asp:Label ID="Label5" runat="server" Text="0" ForeColor="#329040"></asp:Label>
                       </div>
                       <div class="checkbox">
                            <div class="checkbox">
                              <table style="width: 93%;">
            ...
            <div class="FormIdiomas">
                 <h1>Conocimiento de idiomas</h1>
                  <div class="ContSlider">
                       <h3>Asigne un valor para este criterio</h3>
                       <input id="Range6" type="range" runat="server" value="0" min="1" max="100" oninput="document.getElementById('Label6').textContent = this.value;"  />
                       <asp:Label ID="Label6" runat="server" Text="0" ForeColor="#329040"></asp:Label>
                  </div>
                   <div class="ContSlider">
                        <h3>Dominio del Inglés</h3>
                        <input id="RangoIngles" type="range" runat="server" value="0" min="1" max="100" oninput="document.getElementById('lblRIngles').textContent = this.value;"  />
                        <asp:Label ID="lblRIngles" runat="server" Text="0" ForeColor="#329040"></asp:Label>
                    </div>
                    <div class="ContSlider">
                        <h3>Dominio del francés</h3> 
                        <input id="RangoFrances" type="range" runat="server" value="0" min="1" max="100" oninput="document.getElementById('lblRFrances').textContent = this.value;"  />
                        <asp:Label ID="lblRFrances" runat="server" Text="0" ForeColor="#329040"></asp:Label>
                    </div>
                    <div class="ContSlider">
                        <h3>Dominio del portugues</h3>
                         <input id="RangoPortugues" type="range" runat="server" value="0" min="1" max="100" oninput="document.getElementById('lblRPortugues').textContent = this.value;"  />
                        <asp:Label ID="lblRPortugues" runat="server" Text="0" ForeColor="#329040"></asp:Label>
                    </div>
                    <div class="ContSlider">
                        <h3>Dominio del japones</h3>
                         <input id="RangoJapones" type="range" runat="server" value="0" min="1" max="100" oninput="document.getElementById('lblRJapones').textContent = this.value;"  />
                        <asp:Label ID="lblRJapones" runat="server" Text="0" ForeColor="#329040"></asp:Label>
                    </div>
                    <div class="ContSlider">
                         <h3>Dominio del chino</h3>
                         <input id="Range1" type="range" runat="server"  value="0" min="1" max="100" oninput="document.getElementById('lblRChino').textContent = this.value;"  />
                        <asp:Label ID="lblRChino" runat="server" Text="0" ForeColor="#329040"></asp:Label>
                    </div>
